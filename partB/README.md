...
10 JSON files (`llm_task_1_1.json` through `llm_task_4_2.json`) documenting:
- Task name and date
...
| `llm_task_1_1.json` through `llm_task_4_2.json` | LLM usage disclosure (10 files) |
| `requirements.txt` | Python dependencies |
...
### LLM Transparency
- 10 JSON disclosure files document what was generated, by what model, for what purpose
