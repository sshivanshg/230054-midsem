...
int resize_cleanup(int size_active, int **ptr_idle, double **ptr_alpha, double **ptr_delta, double **ptr_gammaG0, double **ptr_proximal_rhs, double ***ptr_G, DOC ***ptr_dXc, double **ptr_cut_error);
